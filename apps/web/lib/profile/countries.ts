// Static ISO 3166-1 country data (code + English name + E.164 dial code).
// Static on purpose: no Intl/CLDR at runtime, so server render and browser
// hydration always see the exact same list (no hydration drift). Names come
// from the ISO list; dial codes are the E.164 country calling codes.
...
// Dial codes for the phone country-code selector, de-duplicated + sorted.
export const DIAL_CODES: string[] = Array.from(
